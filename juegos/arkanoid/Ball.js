...
export var BASE_VELOCITY = 350;
export var BASE_ANGLE =  Math.PI / 3; //Está en radianes (60º)
...
export function Ball(position, sprite, sound, lives, scene)
{
